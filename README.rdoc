Andrew Brown Note about this gem:

The versioning of this gem has changed and I wasn't able to 
find '3.1.5' so I've published this gem just so it work with
my linked_in gem at: git://github.com/omenking/linkedin.git

You should look at using the up to date gem here:
